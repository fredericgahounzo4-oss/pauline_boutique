...
export const ForgotPassword = () => {
    ...
    // ── ÉTAPE 1 : vérifier email + envoyer code ───────────────────────────────
    ...
    const handleCodeSubmit = (e) => {
        ...
        setError('');
        if (!inputCode.trim()) {
            setError("Veuillez entrer le code reçu par e-mail.");
            return;
        }
        if (inputCode.trim() !== sentCode) {
            setError("Code incorrect. Vérifiez votre e-mail et réessayez.");
            return;
        }
        setStep(3);
    };
        ...
        <div className="min-h-screen bg-background flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <p className="mt-2 text-center text-sm text-text-muted">
                    {step === 1 && "Entrez votre e-mail pour recevoir un code de vérification"}
                                ...
                                <form onSubmit={handleCodeSubmit} className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs text-gray-400 text-center">
                                            Copiez le code reçu par e-mail et collez-le ici
                                        </p>
                                    </div>
                                    <button type="submit"
                                        className="w-full flex justify-center py-3 px-4 rounded-xl text-sm font-semibold text-white bg-primary hover:bg-primary/90 transition-colors">
                                        Vérifier le code →
                                    </button>
                            ...
                            {step === 3 && (
                                <form onSubmit={handlePasswordSubmit} className="space-y-6">
                                    <div className="bg-green-50 border border-green-200 rounded-lg px-4 py-3 text-sm text-green-700">
                                        ✅ Code vérifié — Bonjour <strong>{nomUser}</strong>, choisissez votre nouveau mot de passe.
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                className={inputCls(error && !confirm)}
                                            />
