    ...
    return (
        <div className="min-h-screen bg-background flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <h2 className="text-center text-3xl font-serif font-bold text-text">Bon retour parmi nous</h2>
                <p className="mt-2 text-center text-sm text-text-muted">Connectez-vous pour accéder à votre espace personnalisé</p>
            </div>
                ...
                <div className="bg-surface py-8 px-4 shadow-xl sm:rounded-lg sm:px-10 border border-gray-100">
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <div className="mt-1 relative">
                                <input id="password" name="password"
                                    ...
                                    placeholder="Votre mot de passe" className={inputClass('password')} />
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center">
                                ...
                                <label htmlFor="remember-me" className="ml-2 block text-sm text-text-muted">Se souvenir de moi</label>
                            </div>
                    ...
                    <div className="mt-6">
                        ...
                        <div className="mt-6 grid grid-cols-1 gap-3">
                            <Button variant="outline" className="w-full justify-center">Continuer avec Google</Button>
                        </div>
                    </div>
                </div>
                <p className="mt-8 text-center text-sm text-text-muted">
                    Pas encore de compte ?{' '}
                    <Link to="/register" className="font-medium text-primary hover:underline">Créez-en un ici</Link>
                </p>
            </div>
        </div>
    );
