...
export const Shop = () => {
    ...
    useEffect(() => {
        if (urlCategory) {
            // Mise en majuscule de la première lettre pour correspondre aux catégories
    ...
    // Mélange des produits pour l'ordre "En vedette" (Featured)
