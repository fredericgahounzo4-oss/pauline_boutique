...
export const AdminDashboard = () => {
    ...
    useEffect(() => {
        fetch('/api/admin/stats.php')
            ...
            .catch(() => setError('Erreur réseau. Vérifiez que XAMPP est lancé.'))
                ...
                <>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
                        {[
                            ...
                            { label: "Chiffre d'affaires", value: stats.chiffre_affaires.toLocaleString('fr-FR') + ' FCFA', color: 'bg-green-50 text-green-700' },
                        ].map((s, i) => (
