...
export const AdminProduits = () => {
    ...
    const openAdd = () => {
        setEditId(null);
        setForm({ ...initialForm, categorie_id: categories[0]?.id || '1' });
        setPreview(null);
        setShowModal(true);
    };
    ...
    const handleSubmit = async (e) => {
        ...
        const url = editId
            ? apiUrl('/api/admin/produits/edit')
            : apiUrl('/api/admin/produits/add');
    ...
    const handleDelete = async (id, nom) => {
        ...
        try {
            const res  = await fetch(apiUrl('/api/admin/produits/delete'), {
                method:  'POST',
    ...
    const filtered = produits.filter(p =>
        ...
        (p.categorie_nom || p.categorie || '').toLowerCase().includes(search.toLowerCase())
    );
    ...
    return (
        <div className="pt-8 pb-20 px-4 max-w-7xl mx-auto">
            ...
            <input type="text" placeholder="Rechercher par nom ou catégorie..."
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-4">
                            <div>
                                ...
                                <div className="flex items-center gap-4">
                                    {preview && <img src={preview} alt="preview" className="w-20 h-20 object-cover rounded-lg border border-gray-200" />}
